...
public class TotalAll {
    public static void main(String[] args) throws IOException {
        ...
        try (FileReader fr = new FileReader("src/main/resources/in.txt");
             FileWriter fw = new FileWriter("src/main/resources/out.txt")) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("src/main/resources/in.txt"));
             BufferedWriter bw = new BufferedWriter(new FileWriter("src/main/resources/out.txt"))) {
...
//            читаем-записываем или выводим строками
        ...
        try (PrintStream ps = new PrintStream("src/main/resources/out.txt")) {
            String text = "Hello world";
        ...
        List<String> lines = Files.readAllLines(Paths.get("src/main/resources/in.txt"), UTF_8);//читаем построчно файл
        Files.write(Paths.get("src/main/resources/out.txt"), lines);//записали файл
        for (String item : lines) {
            System.out.println(item);
        }//вывели

        //прочитали-записали-вывели
        try (InputStream is = Files.newInputStream(Paths.get("src/main/resources/in.txt"));
             OutputStream os = Files.newOutputStream(Paths.get("src/main/resources/out.txt"))) {
